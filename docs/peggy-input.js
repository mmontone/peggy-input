...
function peg$parse(input, options) {
  ...
  var peg$f0 = function(els) { return els.join('') };
  var peg$f1 = function(body) { return "&{return peggyInput._grammarCompleter(" + body + ")}" };
  var peg$f2 = function(completerName, completerVar) { return "'" + completerName + "'," + completerVar };
  var peg$f3 = function(completerVarName) { return "'" + completerVarName + "'," + completerVarName };
  ...
  function peg$parsecompleterBlock() {
  ...
  function peg$parsecompleterBody() {
    var s0, s1, s2, s3, s4, s5;
...
},{"./completerblock":1,"jquery":2,"lodash":3,"loglevel":4,"peggy":5}]},{},[6]);
